...
export const HomeEnCopy = {
    ...
    cards: [
      {
        ...
        infoTooltip:
          "APY is based on (l) the current yield advertised by the underlying protocol, (ll)  the current distribution rate of governance tokens provided by underlying lending protocols (lll) the current estimated price of governance tokens from Uniswap spot prices. (lV) IDLE token distribution is referred to the entire pool",
        token: {
          value: "USDT",
          title: "TOKEN",
          logoSrc: "tusd.svg",
      ...
      },
      {
        ...
        infoTooltip:
          "APY is based on (l) the current yield advertised by the underlying protocol, (ll) the current distribution rate of governance tokens provided by underlying lending protocols (lll) additional APY derived from staking",
        token: {
          value: "USDT",
          title: "TOKEN",
          logoSrc: "tusd.svg",
  ...
  playersSection: {
    ...
    subtitle:
      'Join our Partner Program<br />and get up to <a href="https://docs.idle.finance/products/get-involved" target="_blank">50% fee share</a>',
    points: [
      {
        btnTitle: "Join",
        linkTitle: "Learn more",
        linkHref:
          "https://docs.idle.finance/products/get-involved/integrators-program",
        btnSrc:
          "https://idlefinance.typeform.com/to/PUC7nO?typeform-source=docs.idle.finance",
      ...
      },
      {
        ...
        linkTitle: "Learn more",
        linkHref:
          "https://docs.idle.finance/products/get-involved/institutions-program",
        btnSrc:
          "https://idlefinance.typeform.com/to/Bumd4UjV?typeform-source=docs.idle.finance",
  ...
  rewardSection: {
    ...
    btnLearn: {
      btnTitle: "Learn More",
      btnSrc:
        "https://idlelabs.notion.site/IGP-Idle-Grants-Program-a91d2937f24c4539a6538e48777fbfbd",
    },
  },
  communitySection: {
