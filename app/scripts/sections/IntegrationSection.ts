...
export default class IntegrationSection extends Section {
    ...
    private _setupAnimItems(){
        gsap.set([this._title, this._desc, this._cardTitle, this._cardDesc, this._cardIcon ], { autoAlpha: 0 });
    }
    ...
    protected _show = () => {
        ...
        return tl
            ...
            .fromTo(this._desc, fromSettings, toSettings, AnimationValues.stagger)
